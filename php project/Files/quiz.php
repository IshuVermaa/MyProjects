...
$qr1="select * from mst_question where test_id=".$tid;
$rs=mysqli_query($cn,$qr1) or die(mysqli_error());
...
else
{
		...
		else if($submit=='Get Result' && isset($ans))
		{
				...
				echo "</table>";
				$qr="insert into mst_result(login,test_id,test_date,score) values('$login',$tid,date(sysdate()),$_SESSION[trueans])";
				
				mysqli_query($cn,$qr)or die(mysqli_error());
...
$qr2="select * from mst_question where test_id=".$tid;
$rs=mysqli_query($cn,$qr2) or die(mysqli_error());
if($_SESSION[qn]>mysqli_num_rows($rs)-1)
{
unset($_SESSION[qn]);
echo "<h1 class=head1>Some Error  Occured</h1>";
session_destroy();
echo "<h1 class=head2>Please <a href=index.php> Start Again</a></h1>";
